...
public class LoggingManager {
    ...
    private static Handler[] originalHandlers = new Handler[0];
    private static Map<Handler, Formatter> originalFormatters = new HashMap<Handler, Formatter>();
    private static Map<Handler, Level> originalLogLevels = new HashMap<Handler, Level>();
    ...
    public static synchronized Log configureLogging(RemoteControlConfiguration configuration, boolean debugMode) {
        ...
        if (configuration.dontTouchLogging()) {
            shortTermMemoryHandler = new ShortTermMemoryHandler(0, Level.OFF, new TerseFormatter(false));
            perSessionLogHandler = new PerSessionLogHandler(0, Level.OFF, new TerseFormatter(false));
